  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', inset: '0', padding: '15mm' }}>
        ...
        <img src={logoUrl || '/logotipo.png'} alt="Logotipo Emerson Reis" style={{ position: 'absolute', left: '15mm', top: '92mm', height: '45mm', width: 'auto', maxWidth: '60mm', filter: 'none', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }} />
        ...
        const cartaCobrancaHtml = `
          <div style="page-break-after: always; width: 210mm; height: 297mm; padding: 16mm; margin: 0; background: white; box-shadow: none; border: none; font-family: sans-serif; overflow: hidden;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10mm;">
              <img src="${absoluteLogo}" alt="Logotipo Emerson Reis" style="height: 16mm; width: auto; -webkit-print-color-adjust: exact; print-color-adjust: exact; filter: none;" />
